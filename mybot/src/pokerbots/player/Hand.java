...
public class Hand implements Comparable<Hand> {
    ...
    public static void main(String[] args) {
        ...
        Card[] twoPair = {Card.valueOf("Ts"),Card.valueOf("Tc"),Card.valueOf("9s"),Card.valueOf("9c"),Card.valueOf("Js")};
        Card[] triple = {Card.valueOf("Ts"),Card.valueOf("Tc"),Card.valueOf("Td"),Card.valueOf("9c"),Card.valueOf("Js")};
        ...
        System.out.println(Hand.eval(test1).toString());
        System.out.println(Hand.eval(test2).toString());
        System.out.println(Hand.eval(test3).toString());
    }
}
