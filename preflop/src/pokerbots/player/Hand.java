...
public class Hand implements Comparable<Hand> {
    ...
    public static void main(String[] args) {
        CardSet test1 = new CardSet();
        CardSet temp = new CardSet();
        CardSet test2 = new CardSet();
        CardSet test3 = new CardSet();
        CardSet test4 = new CardSet();
        CardSet test5 = new CardSet();
        CardSet test6 = new CardSet();
        CardSet test7 = new CardSet();
        CardSet test8 = new CardSet();
        CardSet test9 = new CardSet();
        CardSet test10 = new CardSet();
        CardSet test11 = new CardSet();
        ...
        for (Card card: flushS) {
            test6.add(card);
        }
        for (Card card: flushC) {
            test7.add(card);
        }
        for (Card card: fullhouse) {
            test8.add(card);
        }
        for (Card card: fourKind) {
            test9.add(card);
        }
        ...
        System.out.println(Hand.eval(test4).toString() + Hand.eval(test4).getValue()/max);
        System.out.println(Hand.eval(test5).toString() + Hand.eval(test5).getValue()/max);
        System.out.println(Hand.eval(test6).toString() + Hand.eval(test6).getValue()/max);
        System.out.println(Hand.eval(test7).toString() + Hand.eval(test7).getValue()/max);
        System.out.println(Hand.eval(test8).toString() + Hand.eval(test8).getValue()/max);
        System.out.println(Hand.eval(test9).toString() + Hand.eval(test9).getValue()/max);
        System.out.println(Hand.eval(test10).toString() + Hand.eval(test10).getValue()/max);
        System.out.println(Hand.eval(test11).toString() + Hand.eval(test11).getValue()/max);
    }
}
